//
// Created by Darren Wu on 2/10/21.
//
...
template <typename ItemType>
int subsequence(const ItemType& seq1, const ItemType& seq2);
...
template <typename ItemType>
void interleave(const ItemType& seq1, const ItemType& seq2, ItemType& result);
